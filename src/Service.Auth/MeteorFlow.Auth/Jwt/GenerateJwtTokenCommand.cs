...
internal class GenerateJwtTokenCommandHandler(SecurityTokenHandler tokenHandler, IUserClaimsPrincipalFactory<User> claimsPrincipalFactory, IConfiguration configuration)
