...
//
// public class SyncUsersCommand : ICommand<User>
// {
//     public int SyncedUsersCount { get; set; }
// }
//
// public class SyncUsersCommandHandler : ICommandHandler<SyncUsersCommand, User>
// {
...
//     }
//
//     private async Task<User> SyncToAzureAdB2C(SyncUsersCommand command)
//     {
