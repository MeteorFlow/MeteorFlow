...
internal class AddUpdateInstanceCommandHandler(IServices<Entities.AppInstances, Guid> instanceService, IUnitOfWork unitOfWork) : ICommandHandler<AddUpdateInstanceCommand, Entities.AppInstances>
{
