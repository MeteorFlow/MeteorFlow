...
internal class DeleteInstanceCommandHandler(IServices<Entities.AppInstances, Guid> instanceService, IUnitOfWork unitOfWork) : ICommandHandler<DeleteInstanceCommand, Entities.AppInstances>
{
